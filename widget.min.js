!(function (e) {
  ...
  function (e, t, n) {
    var o = document.querySelector('script[data-name="ECB-Widget"]');
    window.addEventListener("DOMContentLoaded", function () {
      ...
      (e.id = "ecb-btn"),
        ...
        (e.innerHTML =
          '<img src="https://chatbot.exeloncircuits.com/assets/img/message.svg" alt="Message" style="height: 35px; width: 35px; margin: 0; padding-top: 5px;">'),
        (e.style.zIndex = "9999"),
      ...
      (n.title = "Message"),
        ...
        (n.style.backgroundImage =
          "url(https://chatbot.exeloncircuits.com/assets/img/loader.svg)"),
      ...
      (e.onclick = function () {
        s ||
          (n.src =
            "https://chatbot.exeloncircuits.com" +
            "?id=" +
            o.dataset.id +
            "&color=" +
